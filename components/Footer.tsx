      ...
      <div className="container">
        <div className="footer-top">
          ...
          <nav className="footer-links" aria-label="Link a fondo pagina">
            <Link href="/#events">Esplora</Link><Link href="/review">In revisione</Link>
        ...
        <p className="footer-credit">Icona del sito: Madonnina, da una foto di Ibex73 / Wikimedia Commons, CC BY-SA 4.0.</p>
      </div>
    </footer>
  );
}
