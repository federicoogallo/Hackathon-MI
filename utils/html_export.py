...
.elite-canvas{position:absolute;inset:0;width:100%;height:100%;z-index:1;pointer-events:none}
...
.hero-layout{position:relative;z-index:2;display:grid;grid-template-columns:minmax(0,1.06fr) minmax(420px,.94fr);gap:72px;align-items:center;min-height:calc(100dvh - 92px);padding:60px 0 68px}
...
.hero-title{position:relative;font-family:'Space Grotesk','Inter',sans-serif;font-weight:700;font-size:clamp(5rem,7.1vw,8.6rem);line-height:.82;max-width:900px;text-wrap:balance;letter-spacing:0;isolation:isolate;perspective:1200px}
.hero-title::before{content:'';position:absolute;inset:-.16em -.08em;z-index:-1;background:linear-gradient(90deg,rgba(66,240,221,.18),rgba(107,140,255,.2),transparent 72%);filter:blur(34px);opacity:.72;transform:scaleX(var(--title-ready,0));transform-origin:left center}
.hero-title .accent{display:block;color:#dfe6ff;text-shadow:0 0 34px rgba(107,140,255,.26)}
.hero-title .title-network{position:absolute;inset:-.18em -.08em;z-index:-1;width:100%;height:100%;pointer-events:none;opacity:.78;mix-blend-mode:screen;filter:saturate(1.18)}
.hero-title .title-word{display:block;white-space:nowrap}
.hero-title .title-char{display:inline-block;color:#f7f8fb;text-shadow:0 0 0 rgba(66,240,221,0);opacity:0;filter:blur(18px);transform:translate3d(var(--tx,0),var(--ty,0),0) scale(.48) rotate(var(--rot,0));transform-origin:50% 62%;transition:opacity .68s cubic-bezier(.16,1,.3,1),filter .78s cubic-bezier(.16,1,.3,1),transform .86s cubic-bezier(.16,1,.3,1),text-shadow .86s ease;will-change:transform,opacity,filter}
.hero-title .title-word.accent-word .title-char{color:#dfe6ff}
.hero-title.is-built .title-char{opacity:1;filter:blur(0);transform:translate3d(0,0,0) scale(1) rotate(0deg);text-shadow:0 0 34px rgba(107,140,255,.28)}
.hero-title.is-built .title-char:nth-child(3n){text-shadow:0 0 30px rgba(66,240,221,.2)}
.hero-title .title-char::selection{background:rgba(66,240,221,.28)}
.hero-copy{position:relative}
.hero-copy::after{content:'SCAN / DEDUPE / SCORE / PUBLISH';position:absolute;left:0;bottom:-34px;font-family:'JetBrains Mono','Inter',monospace;font-size:.72rem;font-weight:800;color:rgba(247,248,251,.22);white-space:nowrap}
...
.product-stage{position:relative;min-height:620px;border-left:1px solid rgba(255,255,255,.1)}
...
.product-viewport{position:sticky;top:104px;min-height:560px;padding:24px 0 0 40px}
.lens-system{position:relative;height:450px;border:1px solid var(--line);border-radius:8px;overflow:hidden;background:
radial-gradient(circle at 58% 42%,rgba(66,240,221,.16),transparent 30%),
radial-gradient(circle at 72% 62%,rgba(107,140,255,.14),transparent 33%),
linear-gradient(145deg,rgba(255,255,255,.13),rgba(255,255,255,.035));box-shadow:0 34px 120px rgba(0,0,0,.38),inset 0 1px 0 rgba(255,255,255,.12)}
...
.elite-story{position:relative;min-height:168dvh;background:#02040a;border-bottom:1px solid var(--line)}
.story-sticky{position:sticky;top:0;min-height:100dvh;display:grid;grid-template-columns:minmax(0,.96fr) minmax(500px,1.04fr);gap:52px;align-items:center;padding:28px 0;overflow:hidden}
.story-copy{position:relative;z-index:3}
.section-kicker{display:block;margin-bottom:14px}
.story-copy h2,.events-head h2{font-family:'Space Grotesk','Inter',sans-serif;font-size:clamp(2.72rem,3vw,3.72rem);line-height:.93;font-weight:700;text-wrap:balance}
.story-copy p,.events-head p{max-width:620px;margin-top:14px;color:rgba(247,248,251,.66);font-size:.96rem;line-height:1.58}
.story-steps{display:grid;gap:6px;margin-top:18px;list-style:none}
.story-step{display:grid;grid-template-columns:38px 1fr;gap:12px;align-items:start;min-height:56px;padding:8px 12px;border:1px solid rgba(255,255,255,.1);border-radius:8px;background:rgba(255,255,255,.04);transition:border-color .24s ease,background .24s ease,transform .24s ease,opacity .24s ease;opacity:.56}
...
.story-step code{font-family:'JetBrains Mono','Inter',monospace;color:var(--cyan);font-weight:800}.story-step b{display:block;color:#fff}.story-step span{display:block;color:var(--muted);margin-top:1px;font-size:.84rem;line-height:1.34}
.story-stage{position:relative;z-index:2;height:min(54dvh,520px);min-height:460px;border:1px solid var(--line);border-radius:8px;overflow:hidden;background:
radial-gradient(circle at 72% 28%,rgba(107,140,255,.16),transparent 32%),
radial-gradient(circle at 25% 70%,rgba(66,240,221,.13),transparent 36%),
linear-gradient(145deg,rgba(255,255,255,.09),rgba(255,255,255,.025));box-shadow:0 34px 130px rgba(0,0,0,.42),inset 0 1px 0 rgba(255,255,255,.1)}
.story-stage::before{content:'';position:absolute;inset:0;z-index:0;background:
...
.story-stage::after{content:'';position:absolute;inset:86px 22px 124px;z-index:0;border:1px solid rgba(66,240,221,.13);border-radius:50%;filter:blur(.2px);opacity:.72;transform:rotate(-8deg)}
.story-canvas{position:absolute;inset:0;width:100%;height:100%;z-index:1;pointer-events:none}
.stage-caption{position:absolute;left:20px;right:20px;top:20px;z-index:2;display:flex;align-items:center;justify-content:space-between;min-height:52px;padding:0 16px;border:1px solid var(--line);border-radius:8px;background:rgba(2,4,10,.62);backdrop-filter:blur(18px);font-family:'JetBrains Mono','Inter',monospace;color:var(--soft);font-weight:800}
.stage-caption span{color:var(--cyan)}
.stage-node{position:absolute;z-index:3;width:150px;min-height:64px;padding:10px 12px;border:1px solid rgba(255,255,255,.13);border-radius:8px;background:rgba(2,4,10,.68);backdrop-filter:blur(18px);box-shadow:0 18px 60px rgba(0,0,0,.28);transform:translate3d(0,0,0) scale(.96);opacity:.58;transition:opacity .24s ease,transform .24s ease,border-color .24s ease,background .24s ease}
.stage-node code{display:block;font-family:'JetBrains Mono','Inter',monospace;color:rgba(66,240,221,.9);font-weight:800;font-size:.72rem}.stage-node strong{display:block;margin-top:5px;color:#fff;font-size:.94rem}.stage-node span{display:block;margin-top:2px;color:var(--muted);font-size:.78rem;line-height:1.35}
.stage-node.is-active{opacity:1;transform:translate3d(0,-4px,0) scale(1);border-color:rgba(66,240,221,.5);background:linear-gradient(145deg,rgba(66,240,221,.16),rgba(2,4,10,.76));box-shadow:0 22px 80px rgba(66,240,221,.14)}
.stage-node.a{left:7%;top:28%}.stage-node.b{left:31%;top:50%}.stage-node.c{left:52%;top:35%}.stage-node.d{right:7%;top:52%}.stage-node.e{right:10%;bottom:21%}
.stage-dashboard{position:absolute;left:20px;right:20px;bottom:20px;z-index:2;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:1px;border:1px solid var(--line);border-radius:8px;overflow:hidden;background:rgba(255,255,255,.12)}
.stage-dashboard div{min-height:64px;padding:12px 16px;background:rgba(2,4,10,.72)}.stage-dashboard span{display:block;color:var(--muted);font-size:.76rem;font-weight:800}.stage-dashboard strong{display:block;margin-top:4px;font-size:1.02rem}
...
.elite-container{width:min(100% - 32px,1200px)}.elite-nav{min-height:78px}.elite-brand>span:not(.elite-logo),.elite-link{display:none}.elite-logo{display:grid!important}.elite-button{padding:0 12px}.hero-layout{min-height:calc(100dvh - 78px);padding:48px 0 56px}.hero-title{font-size:3.15rem}.hero-sub{font-size:1rem}.hero-metrics{grid-template-columns:1fr}.lens-system{height:360px}.signal-chip{left:16px;right:16px;font-size:.76rem}.story-copy h2,.events-head h2{font-size:2.65rem}.story-stage{min-height:520px}.stage-node{width:128px;min-height:58px;padding:10px}.stage-node span{display:none}.stage-node.a{left:5%;top:25%}.stage-node.b{left:44%;top:36%}.stage-node.c{left:9%;top:49%}.stage-node.d{right:7%;top:60%}.stage-node.e{right:8%;bottom:25%}.stage-dashboard{grid-template-columns:1fr}.event-card{grid-template-columns:1fr}.event-date{width:88px}.event-footer{align-items:flex-start;flex-direction:column}.issue-actions{justify-content:flex-start}.filter-pills{display:grid;grid-template-columns:1fr 1fr}.pill{padding:0 10px}}
@media(prefers-reduced-motion:reduce){
html{scroll-behavior:auto}.strip-track{animation:none}.event-card,.story-step,.elite-link,.elite-button,.pill,.issue-link,.card-link,.hero-title .title-char{transition:none!important}.hero-title .title-char{opacity:1!important;filter:none!important;transform:none!important}.hero-title::before{transform:scaleX(1)}.hero-title .title-network{display:none}.elite-canvas,.story-canvas{opacity:.28!important}
}
"""
...
var title=document.getElementById('hero-title'),titleCanvas=null,titleCtx=null,titleChars=[];
function buildTitle(){
if(!title)return;
var label=(title.getAttribute('aria-label')||title.textContent||'Hackathon Milano').replace(/\\s+/g,' ').trim();
title.innerHTML='';
title.setAttribute('aria-label',label);
...
titleCanvas.setAttribute('aria-hidden','true');
title.appendChild(titleCanvas);
titleCtx=titleCanvas.getContext&&titleCanvas.getContext('2d');
label.split(' ').forEach(function(word,wi){
var wordEl=document.createElement('span');
wordEl.className='title-word'+(wi?' accent-word':'');
word.split('').forEach(function(ch,i){
var c=document.createElement('span');
c.className='title-char';
c.setAttribute('aria-hidden','true');
c.textContent=ch;
var spread=(i-(word.length-1)/2);
c.style.setProperty('--tx',(spread*(wi?18:14)+(wi?26:-18))+'px');
c.style.setProperty('--ty',((wi?48:-38)+(i%2?12:-10))+'px');
c.style.setProperty('--rot',((spread*(wi?-3.6:3.2))+(i%2?7:-7))+'deg');
c.style.transitionDelay=(80+wi*210+i*34)+'ms';
wordEl.appendChild(c);
titleChars.push(c);
});
title.appendChild(wordEl);
...
body.style.setProperty('--title-ready','1');
title.classList.add('is-built');
});
}
function drawTitle(now){
if(!title||!titleCtx||!titleCanvas)return;
var rect=title.getBoundingClientRect(),d=Math.min(window.devicePixelRatio||1,2);
if(rect.width<2||rect.height<2){if(!reduce)requestAnimationFrame(drawTitle);return}
titleCanvas.width=Math.max(1,Math.floor(rect.width*d));
titleCanvas.height=Math.max(1,Math.floor(rect.height*d));
titleCtx.setTransform(d,0,0,d,0,0);
titleCtx.clearRect(0,0,rect.width,rect.height);
titleCtx.globalCompositeOperation='lighter';
var t=now*.001,ready=title.classList.contains('is-built')?1:.28;
var pts=titleChars.map(function(c,i){var r=c.getBoundingClientRect();return{x:r.left-rect.left+r.width*.5,y:r.top-rect.top+r.height*.56,live:Math.max(.18,Math.min(1,ready-(i-titleChars.length*.18)*.015))}});
for(var i=0;i<pts.length-1;i++){
var a=pts[i],b=pts[i+1],dist=Math.hypot(b.x-a.x,b.y-a.y);
if(dist<210){
var alpha=(.12+.26*Math.sin(t*1.6+i*.5)*.5+.18)*Math.min(a.live,b.live);
titleCtx.strokeStyle='rgba(66,240,221,'+alpha.toFixed(3)+')';
titleCtx.lineWidth=1;
titleCtx.beginPath();
titleCtx.moveTo(a.x,a.y);
titleCtx.quadraticCurveTo((a.x+b.x)*.5,(a.y+b.y)*.5+(i%2?18:-18),b.x,b.y);
titleCtx.stroke();
}
}
pts.forEach(function(p,i){
var pulse=(Math.sin(t*2.2+i*.73)+1)*.5;
titleCtx.fillStyle=i%4===0?'rgba(66,240,221,.72)':'rgba(214,223,255,.46)';
titleCtx.beginPath();
titleCtx.arc(p.x,p.y,1.3+pulse*1.6,0,Math.PI*2);
titleCtx.fill();
});
...
if(!sc)return;
var r=sc.size(),ctx=sc.ctx,w=r.width,h=r.height,t=now*.001,p=state.story;
ctx.clearRect(0,0,w,h);
ctx.globalCompositeOperation='lighter';
var cx=w*.57,cy=h*.52;
for(var ring=0;ring<5;ring++){
ctx.strokeStyle='rgba(66,240,221,'+(0.12-ring*.016)+')';
ctx.lineWidth=1;
ctx.beginPath();
ctx.ellipse(cx,cy,72+ring*58+p*34,42+ring*38+p*16,-.18+ring*.13+t*.035,0,Math.PI*2);
ctx.stroke();
}
var steps=w<620?[[w*.22,h*.25],[w*.45,h*.36],[w*.28,h*.50],[w*.58,h*.62],[w*.72,h*.73]]:[[w*.15,h*.31],[w*.36,h*.50],[w*.58,h*.34],[w*.80,h*.51],[w*.78,h*.70]];
ctx.lineCap='round';
for(var i=0;i<steps.length-1;i++){
var a=steps[i],b=steps[i+1],seg=clamp(p*4-i);
var x=a[0]+(b[0]-a[0])*seg,y=a[1]+(b[1]-a[1])*seg;
ctx.strokeStyle='rgba(66,240,221,'+(0.18+seg*.62)+')';
ctx.lineWidth=2.2+seg*1.1;
ctx.shadowColor='rgba(66,240,221,.42)';
ctx.shadowBlur=seg*16;
ctx.beginPath();
ctx.moveTo(a[0],a[1]);
var mx=(a[0]+b[0])*.5,my=(a[1]+b[1])*.5+(i%2?-52:50);
ctx.quadraticCurveTo(mx,my,x,y);
ctx.stroke();
ctx.shadowBlur=0;
}
steps.forEach(function(pt,i){
var active=p>i/5-.04;
ctx.fillStyle=active?'rgba(255,255,255,.96)':'rgba(170,185,220,.24)';
ctx.beginPath();ctx.arc(pt[0],pt[1],active?6:4,0,Math.PI*2);ctx.fill();
if(active){
ctx.strokeStyle='rgba(66,240,221,.34)';
ctx.lineWidth=1;
ctx.beginPath();ctx.arc(pt[0],pt[1],22+Math.sin(t*2+i)*4,0,Math.PI*2);ctx.stroke();
}
});
ctx.globalCompositeOperation='source-over';
if(!reduce)requestAnimationFrame(drawStory);
}
function update(){state.hero=progress(hero,.58);state.story=progress(story,.28);body.style.setProperty('--hero-p',state.hero.toFixed(3));body.style.setProperty('--story-p',state.story.toFixed(3));var idx=Math.min(4,Math.max(0,Math.floor(state.story*5)));document.querySelectorAll('[data-story-step]').forEach(function(el,i){el.classList.toggle('is-active',i===idx||state.story>i/5+.12)});document.querySelectorAll('[data-stage-node]').forEach(function(el,i){el.classList.toggle('is-active',i===idx||state.story>i/5+.12)})}
var ticking=false;function request(){if(!ticking){ticking=true;requestAnimationFrame(function(){ticking=false;update()})}}
update();if(titleCtx&&!reduce)requestAnimationFrame(drawTitle);if(hc)requestAnimationFrame(drawHero);if(sc)requestAnimationFrame(drawStory);
...
def _build_html(
    ...
    return (
        ...
        '<h1 id="hero-title" class="hero-title" aria-label="Hackathon Milano">Hackathon <span class="accent">Milano</span></h1>\n'
        ...
        '<h2>Dal rumore pubblico a un calendario ad alta fiducia.</h2>\n'
        '<p>Il motore trasforma segnali pubblici dispersi in una mappa operativa: fonti, deduplica, scoring AI e review umana convergono in un output pronto da usare.</p>\n'
        ...
        '</ol>\n'
        '</div>\n'
        '<div class="story-stage" aria-hidden="true"><canvas class="story-canvas" id="elite-story-canvas"></canvas><div class="stage-caption"><span>Signal routing</span><strong>Confidence graph</strong></div>'
        '<div class="stage-node a" data-stage-node><code>01</code><strong>Collect</strong><span>fonti pubbliche</span></div>'
        '<div class="stage-node b" data-stage-node><code>02</code><strong>Dedupe</strong><span>cluster record</span></div>'
        '<div class="stage-node c" data-stage-node><code>03</code><strong>Score</strong><span>fiducia AI</span></div>'
        '<div class="stage-node d" data-stage-node><code>04</code><strong>Review</strong><span>controllo umano</span></div>'
        '<div class="stage-node e" data-stage-node><code>05</code><strong>Publish</strong><span>output Pages</span></div>'
        '<div class="stage-dashboard"><div><span>Refresh</span><strong>24h</strong></div><div><span>Scope</span><strong>Milano</strong></div><div><span>Output</span><strong>verified</strong></div></div></div>\n'
        '</div>\n'
        '</section>\n'
