...
.story-stage{position:relative;z-index:2;min-height:620px;border:1px solid var(--line);border-radius:8px;overflow:hidden;background:
...
.stage-node{position:absolute;z-index:3;width:156px;min-height:74px;padding:12px 13px;border:1px solid rgba(255,255,255,.13);border-radius:8px;background:rgba(2,4,10,.68);backdrop-filter:blur(18px);box-shadow:0 18px 60px rgba(0,0,0,.28);transform:translate3d(0,0,0) scale(.96);opacity:.58;transition:opacity .24s ease,transform .24s ease,border-color .24s ease,background .24s ease}
...
.stage-node.a{left:7%;top:27%}.stage-node.b{left:29%;top:48%}.stage-node.c{left:51%;top:31%}.stage-node.d{right:7%;top:48%}.stage-node.e{right:9%;bottom:23%}
