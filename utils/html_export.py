...
def _build_html(
    ...
    html = (
        ...
        '<div class="intel-orbit"></div><div class="intel-orbit two"></div><div class="radar-core"></div>\n'
        '<div class="intel-node one">public sources</div><div class="intel-node two">dedupe graph</div><div class="intel-node three">ai confidence</div><div class="intel-node four">pages output</div>\n'
        '<div class="radar-metrics"><div class="radar-metric"><span>refresh</span><strong>24h</strong></div><div class="radar-metric"><span>scope</span><strong>Milano</strong></div><div class="radar-metric"><span>queue</span><strong>human</strong></div></div>\n'
        '</div>\n'
        '</div>\n'
        '</section>\n\n'
        # Toolbar
